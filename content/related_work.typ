...
This chapter reviews prior work in three areas that are directly relevant to this thesis: human-in-the-loop grading workflows, LLM-supported authoring, and instructor-facing AI assistance. The final section synthesizes these strands to derive the research gap and position this thesis contribution.

== Human-in-the-Loop Grading Workflows

Current research on LLM-supported educational workflows shows a consistent pattern: LLMs reduce manual effort, but reliable use still requires explicit human review. Grading-focused studies demonstrate this clearly. Xu et al. combine ChatGPT-4o grading with a human revision step #cite(<Xu2025469>), and Cisneros-González et al. report a JorGPT workflow in which instructors choose both model and rubric #cite(<Cisneros-Gonzalez2025>). Bernik et al. report close agreement between AI and teacher grades overall, with stricter AI grading in specific submissions #cite(<Bernik2025>).
...
Instructor-facing support systems extend beyond grading and authoring into daily teaching workflows. Wolff et al. present EDUHints, in which AI generates candidate hints for students who work on hands-on cybersecurity exercises and instructors review these hints before students see them #cite(<Wolff2025897>). In Artemis, Iris already provides student-facing AI tutoring, which creates a strong baseline for extending assistance toward instructor and editor tasks #cite(<Bassner2024394>). Dietrich et al. extend this instructor-facing direction with LLM-based multi-artifact consistency verification in Artemis, where Hyperion reports structured consistency issues across problem statement, template, solution, and tests #cite(<Dietrich2025>). Frameworks by Tan et al. and Tebourbi et al. emphasize structured generation workflows, explicit evaluation, and human validation #cite(<Tan2025>) #cite(<Tebourbi2025>).
