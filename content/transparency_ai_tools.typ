...
I used ChatGPT to enhance language quality and translate the abstract. I used ChatGPT to generate initial drafts and expand on ideas throughout the thesis, providing valuable suggestions and examples. Additionally, I used Codex with ChatGPT to generate code snippets for the developed functionality. I have carefully checked all texts created with these tools to ensure that they are correct and make sense.
