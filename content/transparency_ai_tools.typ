...
I used ChatGPT in all chapters of this thesis for initial drafts, idea expansion, and language refinement of existing text. I also used ChatGPT for translation support in the abstract and then revised the translated text manually. For the implementation, I used Codex with ChatGPT to generate, review, and refine code snippets for the developed functionality. I manually reviewed and validated all AI-generated text and code before including it.
