...
Review comment systems provide a structured way to discuss and track issues in evolving artifacts. Instead of treating findings as ephemeral output, a review system models issues as threads anchored to a location in a document (e.g., a file and line range) with one or more comments that capture rationale and discussion. This representation supports collaboration by allowing multiple instructors and editors to contribute context, propose alternatives, and converge on a decision.
