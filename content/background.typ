...
This thesis follows the HITL paradigm by turning LLM-detected consistency issues into review threads that instructors and editors can act on directly. The system integrates AI proposals into a familiar review workflow with persistent threads, resolution states, and safe application of suggested code changes. Instructors and editors remain responsible for the final outcome, while the system reduces the mechanical effort of identifying, tracking, and navigating consistency issues.
...
For the scope of this thesis, review threads provide the foundation for turning consistency checking into an actionable workflow. They enable persistent storage of detected consistency issues, integrate manual instructor and editor feedback and AI-generated consistency issues into a unified interface, and provide a clear record of what was changed and why. This is essential for exercise development over time, where the cost of repeatedly interpreting raw tool output would otherwise remain high.
